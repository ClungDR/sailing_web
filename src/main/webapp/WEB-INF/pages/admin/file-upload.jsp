...
<div class="content-fluid">
        ...
        <div class="left-side-inner">
            <ul class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <li class="panel panel-default active">
                    <div class="panel-heading" role="tab">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#file-manage" aria-expanded="true" aria-controls="file-manage">
                                <i class="icon-file-alt"></i>
                                文件管理
                            </a>
                        </h4>
                    </div>
                    <div id="file-manage" class="panel-collapse collapse in">
                        <ul class="panel-body" >
                            <li><a href="index_alt.html">文件权限</a></li>
                            <li class="active"><a href="index.html">文件上传</a></li>
                        </ul>
                    </div>
                </li>
                <!--  -->
    ...
    <div class="main-content">
        ...
        <!-- header end -->
        <%@include file="content/upload.jsp"%>
